...
namespace clsy.cli.model.tree.visitor.mermaid
{
    public class MermaidGraph
    {
        ...
        private List<clsy.cli.model.tree.visitor.mermaid.MermaidArrow> edges;
        ...
        public MermaidGraph(string graphName, bool directed)
        {
            ...
            edges = new List<clsy.cli.model.tree.visitor.mermaid.MermaidArrow>();
        }
        ...
        public void Add(clsy.cli.model.tree.visitor.mermaid.MermaidArrow edge)
        {
            edges.Add(edge);
        }
        ...
        public IList<clsy.cli.model.tree.visitor.mermaid.MermaidArrow> FindEgdes(MermaidNode node)
        {
